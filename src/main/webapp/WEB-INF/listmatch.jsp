...
<main role="main" class="container">
  ...
  <p class="lead">Bienvenue <b><c:out value="${ connectedUser.login }"></c:out></b></p>
    ...
    <p class="lead">L'onglet "Match" qui permet d'afficher les noms, prénoms et sexes des vainqueurs ou des finalistes. Il dispose également d'un champ de recherche pour filtrer les résultats par nom ou prénom.</p>
  </div>
...
<!-- 	<a type="button" class="btn btn-primary" href="/AppJoueur/ajouterjoueur">Ajouter match</a> -->
</div>
<table class="table">
  <thead>
    <tr>
      <th scope="col" style="width:10%">#</th>
      <th scope="col" style="color:blue" width:25%">Vainqueur</th>
      <th scope="col" style="color:red" width:25%">Finaliste</th>
  ...
  <c:forEach var="match" items="${ matchs }">
    <tr>
      ...
      <td style="color:cornflowerblue;font-weight: 500;"><c:out value="${ match.vainqueur }" /></td>
      <td style="color:palevioletred;font-weight: 500;"><c:out value="${ match.finaliste }" /></td>
      <td><c:out value="${ match.sexe }" /></td>
