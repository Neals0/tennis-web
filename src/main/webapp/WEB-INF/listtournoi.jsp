...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    ...
    <form class="form-inline my-2 my-lg-0" action="listtournoi" method="post" >
      ...
      <button class="btn btn-secondary my-2 my-sm-0" type="submit" name="action2" value="rechercher">Search</button>
...
<main role="main" class="container">
  ...
  <p class="lead">Bienvenue <b><c:out value="${ connectedUser.login }"></c:out></b></p>
    ...
    <p class="lead">L'onglet "Tournois" offre des fonctionnalités telles que l'ajout, la modification et la suppression de tournois. Il dispose également d'un champ de recherche pour filtrer les tournois par nom ou code en tapant une chaîne de caractères.</p>
  </div>
