...
<form class="needs-validation "  novalidate method="post" action="ajoutertournoi">
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" style="width:400px;" id="validationCustom01" name="txtNomTournoi" required>
  ...
  <div class="form-row">
	<div class="col-md-4 mb-3">
	  ...
	  <input type="text" class="form-control" style="width:400px;" id="validationCustom02" name="txtCodeTournoi" required>
	  <div class="valid-feedback">
       Très bien!
     </div>
	</div>
